...
class Activity : AppCompatActivity() {
    ...
    private val fragments = listOf<FragmentInfo>(
        FragmentInfo(R.id.activityMainFragment, ActivityTabs::newInstance, ActivityTabs.tag),
        FragmentInfo(R.id.activityProfileFragment, ProfileFragment::newInstance, ProfileFragment.tag)
    )
