...
import ru.fefu.activitytracker.screens.room.ActivityDistanceUpdate
import ru.fefu.activitytracker.screens.room.calc.distanceTo
...
class ActivityService : Service() {
    ...
    inner class ActivityLocationCallback(private val activityId: Int) : LocationCallback() {
        override fun onLocationResult(result: LocationResult?) {
            ...
            App.INSTANCE.db.activityDao().updateDistance(ActivityDistanceUpdate(
                activityId,
                coordinates
            ))
